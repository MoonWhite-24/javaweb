...
export const refreshOrderImages = (orderNo) => request.post(`/admin/orders/${orderNo}/refresh-images`)
export const refreshAllOrderImages = () => request.post('/admin/orders/refresh-all-images')
